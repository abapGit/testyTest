...
CLASS zcl_abapgit_gui_page_ex_object IMPLEMENTATION.
  ...
  METHOD export_object.
    DATA lv_object_type TYPE I_CustABAPObjDirectoryEntry-ABAPObjectType.
    DATA lt_names TYPE STANDARD TABLE OF I_CustABAPObjDirectoryEntry-ABAPObject WITH DEFAULT KEY.
