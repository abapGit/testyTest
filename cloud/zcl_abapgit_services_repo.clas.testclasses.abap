CLASS ltcl_sap_package_mock DEFINITION FINAL FOR TESTING
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      BEGIN OF c_package,
        existing     TYPE I_CustABAPObjDirectoryEntry-ABAPPackage VALUE '$EXISTING',
        non_existing TYPE I_CustABAPObjDirectoryEntry-ABAPPackage VALUE '$NON_EXISTING',
        user         TYPE I_CustABAPObjDirectoryEntry-ABAPPackage VALUE '$USER',
      END OF c_package.
  ...
  PRIVATE SECTION.
    DATA:
      mv_package TYPE I_CustABAPObjDirectoryEntry-ABAPPackage,
      BEGIN OF ms_called,
...
CLASS ltcl_create_package DEFINITION FINAL FOR TESTING
  ...
  PRIVATE SECTION.
    DATA:
      ...
      mv_created_package  TYPE I_CustABAPObjDirectoryEntry-ABAPPackage.
