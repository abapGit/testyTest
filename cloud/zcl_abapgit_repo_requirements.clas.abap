  ...
  METHOD get_requirement_met_status.
    ...
    LOOP AT it_requirements ASSIGNING <ls_requirement>.
      ...
      IF sy-subrc = 0.
        ...
        SELECT SINGLE desc_text FROM cvers_ref 
          WHERE component = @<ls_installed_comp>-component AND langu = @sy-langu INTO @<ls_status>-description ##SUBRC_OK.
