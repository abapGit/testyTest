CLASS zcl_abapgit_gui_page_chg_pckg DEFINITION
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ty_map,
        old_package TYPE I_CustABAPObjDirectoryEntry-ABAPPackage,
        new_package TYPE I_CustABAPObjDirectoryEntry-ABAPPackage,
      END OF ty_map,
    ...
    METHODS change_package
      IMPORTING
        !iv_old_package TYPE I_CustABAPObjDirectoryEntry-ABAPPackage
        !iv_new_package TYPE I_CustABAPObjDirectoryEntry-ABAPPackage
