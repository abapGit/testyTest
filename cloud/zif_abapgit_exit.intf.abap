INTERFACE zif_abapgit_exit
  ...
  TYPES:
    ty_object_types TYPE STANDARD TABLE OF I_CustABAPObjDirectoryEntry-ABAPObjectType WITH DEFAULT KEY .
  ...
  METHODS create_http_client
    IMPORTING
      !iv_url          TYPE string
    RETURNING
      VALUE(ri_client) TYPE REF TO object
    RAISING
      zcx_abapgit_exception .
  METHODS custom_serialize_abap_clif
    IMPORTING
      !is_class_key    TYPE char30
